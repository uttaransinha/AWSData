...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default='data/NWPU_VHR/VHR-10_dataset_coco/NWPU VHR-10_dataset_coco/AllImages/train.txt')
    parser.add_argument('--test_path', type=str, default='data/NWPU_VHR/VHR-10_dataset_coco/NWPU VHR-10_dataset_coco/AllImages/train.txt')
